...
export default function HomeHero() {
    return (
        <section className="relative">
            {/* Wrapper que asegura ancho completo centrado */}
            <div className="relative left-1/2 -translate-x-1/2 w-screen overflow-hidden">
                ...
                {/* Contenedor del contenido: SIEMPRE anclado abajo */}
                <div className="absolute bottom-6 md:bottom-10 left-1/2 -translate-x-1/2 w-full">
                    <div className="relative ml-4 sm:ml-8 md:ml-16 lg:ml-[72px] w-[min(1240px,calc(100vw-1rem))] sm:w-[min(1240px,calc(100vw-2rem))] md:w-[min(1240px,calc(100vw-4rem))]">
                        {/* Tarjeta translúcida */}
